...
.FPGA resource utilization for the DE0-CV board (Slow 1100mV 85C model, v1.1.1.0).
[[tab_metrics]]
[cols="1,1,1,1]
|===
| Setup | $f_{max}$ | ALMs | FFs | RAM

| Default OCD (all I/O, MD, no extensions, no boot)  | 87 | 3244 | 3144 | 1,313,792
| Default OCD + perf. options                        | 93 | 3244 | 3153 | 1,313,792
| Full OCD (all extensions, fast divider, no boot)   | 78 | 4601 | 3634 | 1,313,792
| Default bootloader (no OCD)                        | 89 | 2623 | 2552 | 1,345,536
| Small (UART1, no boot, no MD, no OCD)              | 90 | 1735 | 1254 | 788,480 
|===
...
|HAVE_CRC              | booleab   | false    | Use CRC unit
