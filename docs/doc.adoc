...
Registers and CSRs are directly accessed via the core. Memory operations are handled by the core's memory interface. If a memory operation times out, the DM will report error code 7. This is not standard.
