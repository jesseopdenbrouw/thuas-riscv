...
OpenOCD can be downloaded from https://sourceforge.net/p/openocd/code/ci/master/tree/[SoureForge]. This is the main line version and excellent support for RISC-V. The specific RISC-V from https://github.com/riscv-collab/riscv-openocd[github] is stale and should not be used.
`
