...
.FPGA resource utilization for the DE0-CV board (Slow 1100mV 85C model, v1.0.0.0).
[[tab_metrics]]
[cols="1,1,1,1]
|===
...
=== Implications on the hardware design
The OCD takes up a fair amount of ALMs and lowers the $f_{max}$ with about 5 MHz.
