...
.FPGA resource utilization for the DE0-CV board (Slow 1100mV 85C model, v1.1.3.0).
[[tab_metrics]]
[cols="1,1,1,1]
|===
| Setup | $f_{max}$ | ALMs | FFs | RAM

| Default OCD (all I/O, MD, no extensions, no boot)  | 91 | 3334 | 3294 | 1,313,792
| Default OCD + perf. options                        | 89 | 3334 | 3325 | 1,313,792
| Full OCD (all extensions, fast divider, no boot)   | 78 | 4792 | 3778 | 1,313,792
| Default bootloader (no OCD)                        | 96 | 2667 | 2716 | 1,345,536
| Small (UART1, no boot, no MD, no OCD)              | 93 | 1657 | 1258 | 788,480 
|===
