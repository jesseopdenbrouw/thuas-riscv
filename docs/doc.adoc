...
The design can also be simulated with http://ghdl.free.fr/[GHDL]. See the `ghdl` sub-directory. After simulating with GHDL, the wavevorms can be viewed with https://gtkwave.sourceforge.net/[GTKWave].
