...
The processor executes at top 1 CPI (clocks per instruction) with a sequential flow of instructions. Current CoreMark tests shows an average CPI of 1.76 with a throughput of 1.94 coremark/MHz (GCC 15.2, 4000 runs).
