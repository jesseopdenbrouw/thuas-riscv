...
The processor executes at top 1 CPI (clocks per instruction) with a sequential flow of instructions. Current CoreMark test shows an average CPI of 1.73 with a throughput of 1.98 coremark/MHz (GCC 15.2, -O3, 4000 runs).
