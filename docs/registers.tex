...
\begin{regdesc}[0.7\textwidth]\begin{reglist}[000000]
\itemsep-1.5ex
\item[PSET] Set atomically bits in the GPIOA output register. If a bit is 1, the corresponding bit in GPIOA\_POUT register is set. If a bit is 0, there is no change to the corrensponding GPIOA\_POUT bit.
\end{reglist}\end{regdesc}

\begin{register}{H}{Port A output clear register GPIOA\_PCLK}{0x00c}%
\label{pclr}%
...
\begin{regdesc}[0.7\textwidth]\begin{reglist}[000000]
\itemsep-1.5ex
\item[PCLR] Clear atomically bits in the GPIOA output register. If a bit is 1, the corresponding bit in GPIOA\_POUT register is cleared. If a bit is 0, there is no change to the corrensponding GPIOA\_POUT bit.
\end{reglist}\end{regdesc}
