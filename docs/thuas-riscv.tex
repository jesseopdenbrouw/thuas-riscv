...
The processor executes at top 1 CPI (clocks per instruction) with a sequential flow of instructions. A preliminary test with CoreMark showed an average CPI of 1.73 with a throughput of 1.93 coremark/MHz (4000 runs).
...
\lstinputlisting[language=C,breaklines=false,linerange={35-42}]{code/riscv.vhd}
...
\lstinputlisting[language=C,breaklines=false,linerange={31-34}]{code/riscv.vhd}
